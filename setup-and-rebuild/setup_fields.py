...
# *** CRITICAL FIX: Add attributes generated by Migration Script ***
# These might not appear in the CSV but are added logic-side.
...
print("\n🎉 Field Setup Complete! (Generated attributes included)")