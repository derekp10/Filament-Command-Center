...
def test_toolhead_scan_with_multi_spool_buffer_sends_only_topmost(page: Page, base_url: str, reset_dom_state_js: str):
    page.goto(base_url)
...
@pytest.mark.usefixtures("require_server")
def test_multispool_dryer_box_scan_still_sends_full_buffer(page: Page, base_url: str, reset_dom_state_js: str):
