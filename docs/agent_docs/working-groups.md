...
| 13 | 🐛 Recent Bugfixes (Weight + Dryer Display + LOC Search) | 4 | ~3–4 hrs | `READY` | [13-recent-bugfixes.md](tasks/13-recent-bugfixes.md) |
...
| Activity Log ubiquity (L154–L158) | Standalone design decision |
