...
> **Status: PROPOSED 2026-06-03.** Triaged during the `feature/buglist-sweep-2026-06-03` autonomous sweep. NOT started — bundled here because all four items share the eject/assign/unbind code surface and should be designed together rather than patched one-off (the one-off history is why L206 is still open). Pick this up as a dedicated session with Derek available for the line-43 decision + live repro.
